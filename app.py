...
if st.query_params["Page"] == 'Data Odyssey 2':
    ...
    data_loc = os.path.join(dirloc, 'Data Odyssey 2', 'assets')
    pyLDAvis_loc = os.path.join(dirloc, 'Data Odyssey 2', 'assets', 'pyLDAvis.html')
    wordcloud_loc = os.path.join(dirloc, 'Data Odyssey 2', 'assets', 'wordcloud.html')
    analysis_loc = os.path.join(dirloc, 'Data Odyssey 2', 'assets', 'analysis_results.pkl')
    model_loc = os.path.join(dirloc, 'Data Odyssey 2', 'model_artifacts', 'fine_tuned_model')
    topic_landscape_loc = os.path.join(dirloc, 'Data Odyssey 2', 'assets', 'topic_landscape.html')
